			...
			<h1>
				...
				<div id="vistaDetallada">
					...
					<div id="right">											
						...
						<p> Contraseña: ${peonza.contrasena}</p>
						<p> Email: ${peonza.punta.email}</p>
						<p> Nombre Usuario: ${user.nombreUsuario}</p>
						<p> Administrador: ${userAdministrador}</p>
						
						<input type="hidden" name="compra" value="${user.id}">			
						
						<a type="BackOffice" value="Modificar" />
						<a href="BackOffice" value="Eliminar"/>			
					</div>
            	</div>
       </div>
	</div>				
